...
def process_epinion_ciao(dataset_name):
    ...
    if dataset_name == "epinion":
        data = data_handler(
            "./dataset/Epinion&Ciao/rating_with_timestamp.mat",
            "./dataset/Epinion&Ciao/trust.mat",
        )
    elif dataset_name == "ciao":
        data = data_handler(
            "./dataset/Epinion&Ciao/ciao/rating_with_timestamp.mat",
            "./dataset/Epinion&Ciao/ciao/trust.mat",
        )
