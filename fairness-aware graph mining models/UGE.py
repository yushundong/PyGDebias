...
class UGE():
    def fit(self,adj, feats, labels,idx_train, model='gcn', debias_method='uge-w', debias_attr='gender', reg_weight=0.5, loss='entropy',lr=0.01,
            weight_decay=5e-4, dim1=64, dim2=16, predictor='dot', seed=0, device='cuda'):
        self.labels=labels
        self.model=model
