...
# Available data choices: 'Credit', 'German', 'Facebook', 'Pokec_z', 'Pokec_n', 'Nba', 'Twitter', 'Google', 'LCC', 'LCC_small', 'Cora', 'Citeseer', 'Amazon', 'Yelp', 'Epinion', 'Ciao', 'Dblp', 'Filmtrust', 'Lastfm', 'Ml_100k', 'Ml_1m', 'Ml_20m', 'Oklahoma', 'UNC', 'Bail'.
# here we take Bail as an example
...
"""
Each model has a corresponding example function, with a full pipeline of init, fit and predict. 
The function name is the model name with additional "_".
all you need is to send the data to the function.
"""
